...
- Install [[https://doomemacs.org][Doom Emacs]], our primary editor
#+begin_src shell
git clone --depth 1 https://github.com/doomemacs/doomemacs ~/.emacs.d
~/.emacs.d/bin/doom install
#+end_src

- Copy my Doom [[https://github.com/shahmilav/doom-emacs-config][config files]] to =~/.doom.d=
- Set up preffered iTerm2 preferences
- Set up yabai, sketchybar and skhd
#+begin_src
